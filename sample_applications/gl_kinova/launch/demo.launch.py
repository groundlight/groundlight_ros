...
def launch_setup(context, *args, **kwargs):
    ...
    world_file = LaunchConfiguration("world_file")  # Added world file configuration
    # General arguments
    ...
    # Gazebo nodes - Modified to include the world file
    gzserver = ExecuteProcess(
        cmd=[
            "gzserver",
            "-s", "libgazebo_ros_init.so",
            "-s", "libgazebo_ros_factory.so",
            world_file  # Use the world file argument here
        ],
        output="screen",
        condition=IfCondition(sim_gazebo),
    )
...
def generate_launch_description():
    declared_arguments = []
    # Added world file argument
    declared_arguments.append(
        DeclareLaunchArgument(
            "world_file",
            default_value="",  # Default to an empty string for blank world
